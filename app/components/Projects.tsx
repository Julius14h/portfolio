...
export default function Projects() {
  const projects = [
    ...
    {
      title: "FormFit App",
      description: "A fitness app prototype for teaching proper exercise techniques",
      details: [
        "Worked in a team to design a fitness app for teaching people how to conduct exercises properly and safely",
        "Translated the paper prototype into a Figma design, creating the UI for the app",
        "Focused on user experience and safety in exercise guidance"
      ],
      tools: ["Figma", "UI/UX Design", "Prototyping"],
      link: "https://www.figma.com/proto/BduzGUJ2k1hkVUf74tmEB8/FormFit-App?node-id=30-334&p=f&t=Uf817QFXoW0t292b-1&scaling=scale-down&content-scaling=fixed&page-id=0%3A1&starting-point-node-id=30%3A334",
